  ...
  return (
    <ul className="nav nav-pills d-flex justify-content-center" id="crisp-tabs">
      <li className="nav-item text-primary">
        <a className={`nav-link crisp-tab  ${isActive(NavigationTabType.MAIN) && 'active'}`} data-toggle="pill" data-tab-name="main"
      ...
      <CommonTabLogic handleTabClick={handleTabClick}
                      ...
                      children={<AddIcon color={isActive(NavigationTabType.INSPECTOR)
                        ?TAB_ICON_COLOR.active
                        :TAB_ICON_COLOR.default}/>}/>
      <CommonTabLogic handleTabClick={handleTabClick}
                      isActive={isActive}
                      activeTab={NavigationTabType.BATCH}
                      children={<AddBulkIcon color={isActive(NavigationTabType.BATCH)
                          ?TAB_ICON_COLOR.active
                          :TAB_ICON_COLOR.default}/>}/>
      <CommonTabLogic handleTabClick={handleTabClick}
                      isActive={isActive}
                      activeTab={NavigationTabType.SETTINGS}
                      children={<SearchIcon color={isActive(NavigationTabType.SETTINGS)
                        ?TAB_ICON_COLOR.active
                        :TAB_ICON_COLOR.default}/>}/>
      <CommonTabLogic handleTabClick={handleTabClick}
                      isActive={isActive}
                      activeTab={NavigationTabType.SETTINGS}
                      children={<SettingsIcon color={isActive(NavigationTabType.SETTINGS)
                        ?TAB_ICON_COLOR.active
                        :TAB_ICON_COLOR.default}/>}/>
      <HelpIcon/>
    </ul>
