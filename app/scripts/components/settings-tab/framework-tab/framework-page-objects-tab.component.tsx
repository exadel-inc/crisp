...
/**
 * Settings -> framework -> page objects tab
*/
export function PageObjectsTab() {
  ...
  */
  const handleImport = () => {
    showImportModal({entity: SettingsEntityType.PAGE_OBJECT_PATTERN});
  };
  ...
  */
  const handleExport = () => {
    showExportModal({entity: SettingsEntityType.PAGE_OBJECT_PATTERN});
  };
  ...
  let optionsFilter = useSelector((state: RootState) =>
    state.settings.framework.objects.filter) as IOptionsFilter;
  ...
  const handleRemoveOption = (id: string) => {
    ...
    showConfirmModal({
      ...
      onConfirm: () => {
        removeOption(option, {
          service: CONFIG.service,
          fullEntityName: 'Page Object pattern "{$name}"',
          dependencies: [],
          links: [],
        });
      },
  ...
  const handleRestore = () => {
    showConfirmModal({
      title: 'Load defaults',
      message: 'Are you sure to load defaults for page object patterns?',
      onConfirm: () => {
        patternService.loadDefaults(PatternType.PAGE_OBJECT);
        console.log('Default page object patterns loaded.');
      },
    });
  };
            ...
            <div className="row">
              <div className="col-12 d-flex justify-content-center mt-1">
                <button type="button"
                  ...
                  data-for="page-object-pattern"
                  onClick={handleRestore}
                >Restore basic PO patterns</button>
              </div>
              <div className="col-12 d-flex justify-content-center mt-1">
                <button type="button"
